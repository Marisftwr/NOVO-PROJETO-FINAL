          ...
          <li class="col-sm-2">
            ...
            <div id="mySidenav2" class="sidenav">
              ...
              <form class="form-inline">
                <input class="form-control col-sm-3" type="search" placeholder="Search" aria-label="Search">
            ...
            <br><br>
    <div class="col-sm-2">
    <button onclick="addLista()" class="btn btn-primary">Adicionar mais livros à lista</button>
    </div><br><br>
    <!--Div para pesquisar livros -->
    <div id="PesqLivros"><br>
      <h2 class="quicksand-regular">Qual livro deseja adicionar à sua lista?</h2><br>
      <div class="search-container">
        <form action="pesquisa.php" method="get">
          <input class="form-control mr-sm-3" type="search" placeholder="Pesquise" name="busca">
          <button id="BotaoPesquisa2" class="btn btn-primary" type="submit"><i class="fa fa-search"><img id="BotaoPesquisa" src="SearchIcon1.png"></i></button>
        </form>
      </div><br>
    </div><br><br>
