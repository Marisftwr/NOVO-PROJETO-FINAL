                    ...
                    <form>
                        ...
                        <div id="cardHeaderProfile" class="card-header"><h4 class=quicksand-regular>Foto de Perfil</h4></div>
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-primary" type="button">Upload nova foto de perfil</button><br><br>
                                <button id="x10" class="btn btn-primary" type="button">Salvar mudanças</button>
                            </div>
                        </div>
                    </div>
                </div>
